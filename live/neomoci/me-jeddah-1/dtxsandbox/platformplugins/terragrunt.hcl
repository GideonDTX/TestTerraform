...
terraform {
  source = "git::git@github.com:Invicara/devops-platformplugins.git//modules/invicara/platformplugins?ref=${local.stack_vars.locals.version}"
}
...
inputs = {
  ...
  platformplugins_version = local.stack_vars.locals.version
